...
public class FileUtil {
    @Value("${server.port}")
    private String port;
    private static final String ip = "https:";
...
//        String imageFilePath = System.getProperty("user.dir")+"/src/main/resources/static/images/"+imageName;
        ...
        return ip+":"+443+"/static/images/" +imageName;
